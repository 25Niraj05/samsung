...
@Service
public class EwbDetailServiceImpl implements EwbDetailService {
    ...
    @Override
    public EwbDetails getData(EwbDetails ewbDetails) {
        return ewbDetailsRepository.findByDocNoAndEwbActiveAndUserGstin(ewbDetails.getDocNo(),
            ewbDetails.getEwbActive(), ewbDetails.getUserGstin());
    }
}
